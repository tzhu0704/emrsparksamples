...
spark-submit \
    --master local[2] \
     --packages org.apache.iceberg:iceberg-spark-runtime-3.5_2.12:1.8.0,org.apache.iceberg:iceberg-aws:1.3.0,software.amazon.awssdk:glue:2.20.0,software.amazon.awssdk:s3:2.20.0,software.amazon.awssdk:kms:2.20.0,software.amazon.awssdk:s3tables:2.29.26  \
